  ...
  const cards = [
    {
      ...
      logoHeight: 48,
      alt: t.ui.finmaAlt,
      title: t.ui.finmaCardTitle,
      detail: `${t.ui.authorisationNo} ${company.regulation.finmaAuthorisationNo} · ${company.regulation.finmaDecisionDate}`,
    ...
    },
    {
      ...
      title: t.ui.auditCardTitle,
      detail: t.ui.auditCardDetail,
