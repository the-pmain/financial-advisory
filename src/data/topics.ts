...
export const topics: Topic[] = [
  ...
  t({
    ...
    subtitle: 'From physical assets to digital ownership.',
    intro: [
      'For generations, investors have owned shares in businesses, financed infrastructure and invested in property. Blockchain technology is changing how these interests can be recorded and administered. This page separates the technology — cryptocurrency, smart contracts, tokenization and security token offerings — from the investment itself.',
      'Real-asset themes such as mining, energy, property, infrastructure and networks are illustrative examples, not current offerings. Public comments from finance leaders are context for tokenization. They are not an endorsement of Helfenstein Group or of any private project.',
      'Helfenstein Group provides information and advice within its agreed services. Clients retain control of their assets and investment decisions. The firm does not provide custody through this service. Capital is at risk, including the risk of losing the entire investment.',
    ],
    highlights: [
      { title: 'Tokenization', text: 'A token records defined rights on a ledger. The legal documents decide what the investor owns and can claim.' },
      { title: 'STOs and ICOs', text: 'A security token offering is still a securities offering. The label is not regulatory approval or a public listing.' },
      { title: 'Real-asset themes', text: 'Mining, energy, property, infrastructure and networks. Illustrative examples, not current offerings.' },
      { title: 'Investor considerations', text: 'Illiquidity, custody, smart-contract defects and regulatory change can all cause loss. Tokenization does not remove those risks.' },
    ],
